...
1. Pour stocker le nombre ajouté au bon endroit, on a besoin de connaitre la position. Ca va être une valeur retournée d'une fonction : d'où la necessité de Ne pa
