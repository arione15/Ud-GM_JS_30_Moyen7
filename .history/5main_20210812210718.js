...
var classe = {
    ...
    calculerMoyenneEleve: function(eleve){
        ...
        for(i=0; i<eleve.notes.length; i++){
            s+=eleve.notes[i];
        } return s/eleve.notes.length;
    },
    calculerMoyenneClasse: function(){
        var s=0;
        s = this.calculerMoyenneEleve(this.marc) + this.calculerMoyenneEleve(this.eric) + this.calculerMoyenneEleve(this.marie);
        return s/3;
    }
}
