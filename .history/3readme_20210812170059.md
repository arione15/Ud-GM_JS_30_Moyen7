# Exercice Moyen 3 : Création de tableaux avec des fonctions et calcul de la mAfficher menu et création d'objet

- Création de 3 fonctions :Afficher un menu (addition ou multiplication de n premiers nombres)
