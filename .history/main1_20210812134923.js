...
function ajouter(tableau, nbre) {
    var nbre = parseInt(readline.question("Quel nombre voulez-vous ajouter ?"));
    var position = trouverPosition(tableau, nbre)
    tab.splice(position, 0, nbre);
